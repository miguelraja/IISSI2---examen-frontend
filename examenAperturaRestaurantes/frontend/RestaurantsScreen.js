...
export default function RestaurantsScreen ({ navigation, route }) {
  ...
  //added to change the status of the restaurant
  ...
  const changeStatus = async (restaurant) => {
    try {
      ...
      showMessage({
        message: `Restaurant ${restaurant.name} succesfully changed its status`,
        type: 'success',
        style: GlobalStyles.flashStyle,
        titleStyle: GlobalStyles.flashTextStyle})
    } catch (error) {
      console.log(error)
      setRestaurantToBeChangedItsSatus(null)
      showMessage({ message: `Restaurant ${restaurant.name} could not be changed its status.`,
        type: 'error',
        style: GlobalStyles.flashStyle,
        titleStyle: GlobalStyles.flashTextStyle
      })
