...
export default function CreateRestaurantScreen ({ navigation }) {
  ...
  const initialRestaurantValues = { name: null, description: null, address: null, postalCode: null, url: null, shippingCosts: null, email: null, phone: null, restaurantCategoryId: null, messageToFans: null }
  const validationSchema = yup.object().shape({
    ...
    messageToFans: yup
      .string()
      .max(255, 'Message to fans too long')
      .nullable()
  })
